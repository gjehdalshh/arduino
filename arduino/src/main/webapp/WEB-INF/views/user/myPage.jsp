...
<div id="mainDiv">
	<div class="mainLogoDivDesktop">
		<img class="mainLogo" onclick="moveHome()" alt=""
			src="/res/img/mainlogo.png">
	</div>
	<div class="mainLogoDivMobile">
		<div class="mainLogoDiv">
			<img class="mainLogo" onclick="moveRecord()" alt=""
				src="/res/img/mainlogo.png">
		</div>
		<div class="mainTitle">너의 목소리가 보여</div>
		<div class="logout">로그아웃</div>
	</div>
	<div class="flex">
		<div class="mainLeftDivMobile">
			<div class="defaultInfoMobileDiv">
				<div>
		...
		<div class="mainLeftDiv">
			<div class="defaultInfoDesktopDiv">
				<div>
					<img class="myProfileImg" alt="" src="/res/img/test.gif">
				</div>
				<div class="myName">${user.user_nm }</div>
	...
	<div class="deleteUser_wrap">
		...
		<div class="msg3">- 메일주소, 핸드폰 번호/기타 연락처 등 회원정보가 모두 삭제되며, 삭제된
			데이터는 복구되지 않습니다.</div>
		<div class="msg4">탈퇴 후에도 작성된 게시글은 그대로 남아 있습니다.</div>
		<div class="msg5">
			- 각 게시판에 등록한 게시물 및 댓글은 탈퇴 후에도 남아있습니다.<br> - 삭제를 원하시는 게시물은 탈퇴 전
			반드시 삭제하시기 바랍니다.<br> - (탈퇴 후에는 게시글 임의 삭제 요청을 받지 않습니다.)
		</div>
...
<script defer src="/res/js/user/myPage.js?ver=26"></script>
