...
let deleteUser_bg = document.querySelector('.deleteUser_bg')
let deleteUser_wrap = document.querySelector('.deleteUser_wrap')

function deleteUserCall() {
	deleteUser_bg.style.display = 'block'
	deleteUser_wrap.style.display = 'block'
}
